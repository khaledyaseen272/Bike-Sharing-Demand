...
“'kaggle' is not recognized as an internal or external command” error was raised when I wanted to view my submission, so I went to view it through Kaggle. Despite not having predictions less than 0, I converted the possible negative values to 0 and submitted the results.
